...
type Section = "overview" | "announcements" | "grades" | "fees" | "attendance";
        ...
        <div style={{ padding: "24px", borderBottom: "1px solid rgba(255,255,255,0.1)" }}>
          <div className="flex items-center gap-3">
            ...
            <div>
              ...
              <p style={{ color: "#CBD5E1", fontSize: "11px", letterSpacing: "2px" }}>STUDENT PORTAL</p>
            </div>
          </div>
        </div>
          ...
          <>
            ...
            {section === "overview" && (
              <div>
                ...
                <p style={{ color: "#6B7280", marginBottom: "32px" }}>Here's your academic summary.</p>

                <div className="grid grid-cols-2 md:grid-cols-3 gap-6 mb-10">
                  {[
                    { label: "Announcements", value: announcements.length, icon: "📢", color: "#FFFDE7" },
                    { label: "Subjects", value: "—", icon: "📚", color: "#EFF6FF" },
                    { label: "Attendance", value: "—", icon: "📅", color: "#F0FDF4" },
                  ].map((stat) => (
            ...
            {section === "grades" && (
              <div>
                <h1 style={{ color: "#1E3A8A", fontSize: "28px", fontWeight: "bold", marginBottom: "24px" }}>My Grades</h1>
                <div style={{ background: "white", borderRadius: "12px", border: "1px solid #CBD5E1", padding: "40px", textAlign: "center" }}>
                  <p style={{ fontSize: "48px", marginBottom: "16px" }}>📝</p>
                  <p style={{ color: "#1E3A8A", fontWeight: "bold", fontSize: "18px", marginBottom: "8px" }}>No grades yet</p>
                  <p style={{ color: "#6B7280", fontSize: "14px" }}>Your grades will appear here once your teachers upload them.</p>
                </div>
              </div>
            )}
            ...
            {section === "fees" && (
              <div>
                <h1 style={{ color: "#1E3A8A", fontSize: "28px", fontWeight: "bold", marginBottom: "24px" }}>My Fees</h1>
                <div style={{ background: "white", borderRadius: "12px", border: "1px solid #CBD5E1", padding: "40px", textAlign: "center" }}>
                  <p style={{ fontSize: "48px", marginBottom: "16px" }}>💰</p>
                  <p style={{ color: "#1E3A8A", fontWeight: "bold", fontSize: "18px", marginBottom: "8px" }}>No fee records yet</p>
                  <p style={{ color: "#6B7280", fontSize: "14px" }}>Your fee records will appear here once the admin uploads them.</p>
                </div>
              </div>
            )}
            ...
            {section === "attendance" && (
              <div>
                <h1 style={{ color: "#1E3A8A", fontSize: "28px", fontWeight: "bold", marginBottom: "24px" }}>Attendance</h1>
                <div style={{ background: "white", borderRadius: "12px", border: "1px solid #CBD5E1", padding: "40px", textAlign: "center" }}>
                  <p style={{ fontSize: "48px", marginBottom: "16px" }}>📅</p>
                  <p style={{ color: "#1E3A8A", fontWeight: "bold", fontSize: "18px", marginBottom: "8px" }}>No attendance records yet</p>
                  <p style={{ color: "#6B7280", fontSize: "14px" }}>Your attendance will be tracked here.</p>
                </div>
              </div>
            )}
          </>
